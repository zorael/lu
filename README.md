...
Miscellaneous general-purpose library modules.
...
* [`net.d`](source/lu/net.d): Connection helpers, including Fibers that resolve addresses, connect to servers and read full strings from connections.
